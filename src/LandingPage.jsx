          ...
          {!user ? (
            <>
              <button
                ...
                disabled={signingIn}
                className={`px-6 py-3 rounded-xl text-sm sm:text-base font-bold transition-all hover:scale-105 flex items-center gap-3 mx-auto shadow-lg ${
                  signingIn
                  ...
                  darkMode
                    ...
                    : 'bg-white text-gray-900 hover:bg-gray-50 border-2 border-gray-300 shadow-xl'
                }`}
              >
